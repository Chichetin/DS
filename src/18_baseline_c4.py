"""
Шаг D4: LGBM на C4 (C3 + seller TE + microcat price stats + dynamics + is_first_sale).

Идентично 13_baseline_c3.py, но читает c4_*.parquet и пишет в artifacts/baseline_c4/.
"""
...
ART = ROOT / "artifacts" / "baseline_c4"
...
def main() -> None:
    t0 = time.time()
    log(f"LGBM C4 baseline. lightgbm={lgb.__version__}, polars={pl.__version__}")
