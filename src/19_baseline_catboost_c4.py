"""
Шаг E7: CatBoost на C4-фичах.

Идентично 15_baseline_catboost.py, но читает c4_*.parquet и пишет в artifacts/baseline_cat_c4/.
Текущий лидер — CatBoost C3 (AUC 0.80464). Цель — побить с обновлённым фича-сетом.
"""
...
ART = ROOT / "artifacts" / "baseline_cat_c4"
...
def main() -> None:
    t0 = time.time()
    import catboost
    log(f"CatBoost C4. catboost={catboost.__version__}, polars={pl.__version__}")
    ...
    # Save out-of-fold prob on holdout (для будущего blending'а)
