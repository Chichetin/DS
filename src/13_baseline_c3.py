"""
Шаг D3: LGBM на C3 (C2 + target encoding для microcat_name, city).

Идентично 10_baseline_c2.py, но читает c3_*.parquet и пишет в artifacts/baseline_c3/.
"""
...
ART = ROOT / "artifacts" / "baseline_c3"
...
def main() -> None:
    t0 = time.time()
    log(f"LGBM C3 baseline. lightgbm={lgb.__version__}, polars={pl.__version__}")
